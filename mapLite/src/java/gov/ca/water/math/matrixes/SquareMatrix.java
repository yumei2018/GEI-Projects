 ...
 * by Ronald Mak 
 * Original Code:  org.jgrasstools.gears.utils.math.matrixes.SquareMatrix @
...
public class SquareMatrix extends Matrix {
  ...
  private void set(Matrix m) {
    this.numRows = this.numCols = Math.min(m.numRows, m.numCols);
  ...
  protected void set(double values[][]) {
    super.set(values);
    this.numRows = this.numCols = Math.min(this.numRows, this.numCols);
  }
  //</editor-fold>
