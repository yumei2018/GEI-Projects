...
public class DateUtil implements Serializable {
  ...
  public final static Long dateDiffInMinutes(java.util.Date startDt, java.util.Date endDt) {
    Long result = null;
    
    if ((startDt != null) && (endDt != null)){
      Long diff = endDt.getTime() - startDt.getTime();
      result = TimeUnit.MILLISECONDS.toMinutes(diff);
    }
    
    return result;
  }
  
  public final static Long dateDiffInSeconds(java.util.Date startDt, java.util.Date endDt) {
    Long result = null;
    
    if ((startDt != null) && (endDt != null)){
      Long diff = endDt.getTime() - startDt.getTime();
      result = TimeUnit.MILLISECONDS.toSeconds(diff);
    }
    
    return result;
  }
  
  public final static Long dateDiffInHours(java.util.Date startDt, java.util.Date endDt) {
    Long result = null;
    
    if ((startDt != null) && (endDt != null)){
      Long diff = endDt.getTime() - startDt.getTime();
      result = TimeUnit.MILLISECONDS.toHours(diff);
    }
  ...
  public final static java.util.Date toDate(Long milliseconds) {
    java.util.Date result = null;
    
    try {
      result = new java.util.Date(milliseconds);
    }
    catch(Exception ex){
      throw new IllegalStateException(
        String.format("%s.%s %s:\n%s"
          ,DateUtil.class.getName()
          ,"toDate(Long)"
          ,ex.getClass().getName()
          ,ex.getMessage()
        )
  ...
  //<editor-fold defaultstate="collapsed" desc="Is Before">
  public final static <DT extends java.util.Date> Boolean isBefore(DT d1, DT d2) {
    return (d1 != null) && (d2 != null) && (d1.getTime() < d2.getTime());
  }
  //</editor-fold>
  
  //<editor-fold defaultstate="collapsed" desc="Is Before">
  public final static <DT extends java.util.Date> Boolean isAfter(DT d1, DT d2) {
    return (d1 != null) && (d2 != null) && (d1.getTime() > d2.getTime());
  }
  //</editor-fold>
}