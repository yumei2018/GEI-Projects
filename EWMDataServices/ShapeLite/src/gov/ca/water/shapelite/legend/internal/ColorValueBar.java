...
/**
 * **************************************************************************
 * Copyright (c) 2008, Colorado School of Mines and others. All rights reserved. This
...
public class ColorValueBar extends JPanel implements ColorMapListener {
  ...
  public ColorValueBar(ColorMap cmap, String label) {
    ...
    _mosaic = new Mosaic(1, 1, EnumSet.of(Mosaic.AxesPlacement.BOTTOM));
    _mosaic.getTileAxisBottom(0).setFont(new Font(label, Font.PLAIN, 10));
    if (label != null) {
...
//    _mosaic.setWidthElastic(0,0);
    _mosaic.setHeightMinimum(0, cbWidth);
    _mosaic.setHeightElastic(0, 0);
  ...
  public void colorMapChanged(ColorMap cm) {
    ...
    if (_pixels == null) {
      ...
      _pixels.setOrientation(PixelsView.Orientation.X1DOWN_X2RIGHT);
